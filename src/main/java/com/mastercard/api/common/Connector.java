...
//------------------------------------protected Helper Methods------------------------------------------------------------------------------------------------------------------------------
     ...
     *
     * @throws com.mastercard.api.common.apiexception.MCApiRuntimeException
     */
    ...
    protected Map<String, String> doRequest(String httpsURL,String requestMethod,
        ...
        if (privateKey == null) {
            throw new MCApiRuntimeException(new UnrecoverableKeyException(NULL_PRIVATEKEY_ERROR_MESSAGE));
        }
     ...
     */
    private Map<String, String> checkForErrorsAndReturnResponse(HttpsURLConnection connection) {
        try {
            if (connection.getResponseCode() >= SC_MULTIPLE_CHOICES ) {
            	String message;
            	if (connection.getErrorStream() != null) {
            		message = readResponse(connection.getErrorStream());
            	} else {
            		message = "";
            	}
                ...
                throw new MCApiRuntimeException(message,connection.getResponseCode());
            } else {
            ...
            throw new MCApiRuntimeException(readResponse(connection.getErrorStream()));
        }
    }
     ...
     *
     */
    private HttpsURLConnection setupConnection(String httpsURL,
     ...
     *
     */
    private void generateAndSignSignature(String httpsURL,String requestMethod, OAuthParameters oparams){
     ...
     * @throws com.mastercard.api.common.apiexception.MCApiRuntimeException if the input url is not formatted properly
     * @see <a href="http://oauth.net/core/1.0/#anchor14">9.1 Signature Base
     *      String</a>
     */
    private String generateSignatureBaseString(String httpsURL,String requestMethod, Map<String, SortedSet<String>> baseParameters){
    ...
    private URI parseUrl(String httpsURL){
        ...
        if ((httpsURL == null) || (httpsURL.length() == 0)) {
            throw new MCApiRuntimeException("Request Url cannot be empty");
        }
     ...
     */
    private static String normalizeParameters(String httpUrl, Map<String, SortedSet<String>> requestParameters) {
     ...
     */
    private static Map<String, SortedSet<String>> parseQuerystring(String queryString) {
     ...
     * @return Signature
     */
    private String sign(String baseString, PrivateKey privateKey){
        try {
     ...
     */
    private String buildAuthHeaderString(String httpsURL,String requestMethod,OAuthParameters params) {
     ...
     */
    private StringBuffer parseParameters(StringBuffer buffer,Map<String, SortedSet<String>> paramMap) {
    ...
    private StringBuffer parseSortedSetValues(StringBuffer buffer,String key,Map<String, SortedSet<String>> paramMap ){
